...
namespace ESI.NET.Logic
{
    public class UniverseLogic
    {
        ...
        /// <returns></returns>
        public async Task<EsiResponse<Models.Universe.Type>> Type(int type_id)
            => await Execute<Models.Universe.Type>(_client, _config, RequestSecurity.Public, HttpMethod.Get, "/universe/types/{type_id}/", replacements: new Dictionary<string, string>()
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<EsiResponse<List<AsteroidBelt>>> AsteroidBelt(int asteroid_belt_id)
